...
INST_RADDRX_WE          0
INST_WADDRX_WE          0 # SRAM 0:加算 1:上書き
INST_RADDRW_WE          0
INST_RADDRX_BAK         0
INST_RADDRW_BAK         0
...
INST_COUNTER0           00000000000000000000000000000000
INST_COUNTER1           00000000000000000000000000000000
...
#1
INST_WADDRX             0000000000000000  #取り出すアドレスを指定
INST_WADDRX_WE          1

//output_send start loop to here
#2
INST_OUTPUT_EN          1 #2bitずらす
INST_OUTPUT_EN_CTRL     000000  #取り出す列を指定
INST_RESULT_PURGE       0 
INST_WCEBX              0 #データを取り出す処理
INST_WADDRX             0000000000000001  #取り出すアドレスを指定  1ずつ加算することでSRAMのアドレスを移動
INST_WADDRX_WE          0
