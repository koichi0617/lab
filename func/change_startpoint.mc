...
//wbuf_send start
#1 データの取り出し開始位置を指定
INST_RADDRX_WE          1 # SRAMを上書き
INST_RADDRX             0000000000000010 # SRAMの開始位置を指定

#2 データ取り出し
INST_RADDRX_WE          0 # SRAMを加算していくように設定
INST_RADDRX             0000000000000001 #1ずつSRAMのアドレスを移動
...
INST_PC                 00000000000000000000000000000011  #ループのジャンプ場所→#3を指定
