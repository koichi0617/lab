...
//Reduction
`define INST_WBUF_SEND 218

// `define INST_WBUF_SEND 1
// `define INST_WBUF_SEND_POOL 2
// `define INST_OUTPUT_SEND 3
// `define INST_OUTPUT_SEND_POOL 4
// `define INST_CONV_CAL 5
// `define INST_CONV_CAL_OUT 6
// `define INST_CONV_CAL_WBUF 7
// `define INST_CAL_WBUF_OUT 8
// `define INST_CAL_WBUF_POOL 9